...
namespace Test_Zhucai.LambdaParser
{
    ...
    public class ExpressionParserManagerTest
    {
        ...
        {
            {
                ...
                Func<int> func = ExpressionParserManager.ParseDelegate<Func<int>>(code);
            ...
            }
            {
                ...
                Func<double> func = ExpressionParserManager.ParseDelegate<Func<double>>(code);
        ...
        public void ParseDelegateTest_StringAdd()
        {
            ...
            Func<string> func = ExpressionParserManager.ParseDelegate<Func<string>>(code);
        ...
        public void ParseDelegateTest_Member_Method_Ctor()
        {
            ...
            Func<int> func = ExpressionParserManager.ParseDelegate<Func<int>>(code);
            Func<int> func2 = ExpressionParserManager.ParseDelegate<Func<int>>(code2);
        ...
        public void ParseDelegateTest_MultiLambdaParam()
        {
            ...
            Func<int, int, string, string> func = ExpressionParserManager.ParseDelegate<Func<int, int, string, string>>(code);
        ...
        public void ParseDelegateTest_Indexer()
        {
            ...
            Func<ArrayList, string> func = ExpressionParserManager.ParseDelegate<Func<ArrayList, string>>(code);
        ...
        public void ParseDelegateTest_OperatorNot()
        {
            ...
            Func<bool, bool> func = ExpressionParserManager.ParseDelegate<Func<bool, bool>>(code);
        ...
        {
            {
                ...
                Func<bool> func = ExpressionParserManager.ParseDelegate<Func<bool>>(code);
        ...
        {
            {
                ...
                Func<object, bool> func = ExpressionParserManager.ParseDelegate<Func<object, bool>>(code);
        ...
        {
            {
                ...
                Func<object, string> func = ExpressionParserManager.ParseDelegate<Func<object, string>>(code);
        ...
        public void ParseDelegateTest_OperatorDoubleQuestionMark()
        {
            ...
            Func<string, string> func = ExpressionParserManager.ParseDelegate<Func<string, string>>(code);
