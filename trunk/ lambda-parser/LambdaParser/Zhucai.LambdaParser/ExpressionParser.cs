...
namespace Zhucai.LambdaParser
{
    ...
    {
        internal HashSet<string> _namespaceSet = new HashSet<string>();
        ...
        public void RegisterNamespace(string theNamespace)
        {
            if (!_namespaceSet.Contains(theNamespace))
            {
                lock (_namespaceSet)
                {
                    _namespaceSet.Add(theNamespace);
                }
            }
        }
        ...
        private Type GetType(string typeName)
        {
            ...
            {
                return GetTypeCore(typeName);
            }
            else
            {
                foreach (string theNamespace in this._namespaceSet)
                {
                    Type type = GetTypeCore(theNamespace + "." + typeName);
                    if (type != null)
                    {
                        return type;
                    }
